...
function initSearch() {
  ...
  request.open('GET', '/lightweight-browser-support/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/lightweight-browser-support/assets/css/just-the-docs-' + theme + '.css');
}
